  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(asstes/img/slide/slide-2.jpg)">
          <div class="container">
...
?>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Contact us the 24 Ambulance service in Dhaka, Bangladesh. We Provide Ac Ambulance service, Non-Ac Ambulance service, Freezing Ambulance service, and Basic life support ICU Ambulance, CCU Ambulance , NICU Ambulance and, Ventilator Machine with Doctors or Brothers. Emergency Ambulance service is available in all districts of Bangladesh..</p>
        </div>
